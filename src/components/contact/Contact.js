        ...
        <section className="contact" id="contact">
            <div className="contact-container">
                ...
                <ul className="contact-socials">
                    ...
                    <li className="contact-logo">
                        <a href="https://www.linkedin.com/in/barrazzoubir/" target="_blank" rel="noopener noreferrer">
                    ...
                    <li className="contact-logo">
                        <a href="https://twitter.com/zoubirbarraz" target="_blank" rel="noopener noreferrer">
                    ...
                    <li className="contact-logo">
                        <a href="https://api.whatsapp.com/send?phone=212674810756" target="_blank" rel="noopener noreferrer">
